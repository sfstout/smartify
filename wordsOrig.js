...
function findWordArray(word) {
	return findWordArrayHelper(word, words, 0, words.length-1);
}

function findWordArrayHelper(word, array, s, e) {
	if (s > e) {
		return null;
	}
	...
	if (word > array[mid][0]) {
		return findWordArrayHelper(word, array, mid+1, e);
	}
	if (word < array[mid][0]) {
		return findWordArrayHelper(word, array, s, mid-1);
	}
}
